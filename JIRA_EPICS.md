...
|-----|---------|------|--------|-----|
| [KAN-353](https://laurent2a.atlassian.net/browse/KAN-353) | Milestone 5: Cytoscape Graph View with Table/Graph Toggle | Story | Done | 2026-05-15 |
...
- M6: Clustering + filter chips + refined search
- M7: Tree-graph hybrid view + Observium theme polish
- M8: systemd unit + crontab + README

---

*Last updated: 2026-05-05 | Branch: feature/netviz-milestone-5*
